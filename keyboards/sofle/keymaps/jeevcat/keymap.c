 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LAlt | LGUI | LCTR |RAISE | /Enter  /       \Space \  |LOWER | RCTR | RGUI | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,    KC_B,       KC_MUTE,    XXXXXXX, KC_N,       KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                 KC_LALT, KC_LGUI, KC_LCTL, MO(_RAISE), KC_ENT,     KC_SPC,  MO(_LOWER), KC_RCTL, KC_RGUI, KC_RALT
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
[_LOWER] = LAYOUT(
  _______, _______, _______, KC_LBRC, KC_RBRC, _______,                      _______, _______, _______, _______, _______, KC_DEL,
  _______, _______, _______, KC_LCBR, KC_RCBR, _______,                      _______, _______, _______, _______, _______, _______,
  _______, KC_EQL,  KC_MINS, KC_LPRN, KC_RPRN, _______,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
  _______, KC_PLUS, KC_UNDS, KC_LABK, KC_RABK, _______, _______,    _______, _______, _______, _______, _______, _______, _______,
...
static void print_logo_narrow(void) {
    ...
    wpm_str[3] = '\0';
    wpm_str[2] = '0' + current_frame % 10;
    wpm_str[1] = '0' + (current_frame /= 10) % 10;
    wpm_str[0] = '0' + current_frame / 10;
